...
const AppDetails = () => {
  ...
  const { title, image, size, companyName, downloads, reviews, ratingAvg, description } = singleApp;
  ...
  return (
    <div>
          ...
          <div>
            ...
            <div className='flex flex-col sm:flex-row sm:gap-10 gap-6'>
              ...
              <div className="flex flex-col items-center sm:items-start">
                ...
                <p className='mt-1 text-3xl sm:text-4xl font-extrabold'>{reviews.toLocaleString()}</p>
              </div>
            </div>
          </div>
      ...
      {/* Chart*/}
        <div className="mt-16 max-w-6xl mx-auto p-4 md:p-8">
