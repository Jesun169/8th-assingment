...
const parseDownloads = (downloadString) => {
  ...
  const value = parseFloat(downloadString);
  if (downloadString.includes('B')) return value * 1_000_000_000;
  if (downloadString.includes('M')) return value * 1_000_000;
  return value; 
};
